# FixSymbolicLink.ps1: A user-friendly script to fix a symbolic link and run setup.sh
...
Write-Info "Welcome! This script fixes broken symbolic links and runs setup.sh."
